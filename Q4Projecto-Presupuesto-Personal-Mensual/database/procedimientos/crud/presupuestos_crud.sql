...
BEGIN
    ...
    IF v_anio_final < v_anio_inicio THEN
        RAISERROR 20000 'El a�o final no puede ser menor que el a�o inicial';
    END IF;

    IF v_anio_final = v_anio_inicio AND v_mes_final < v_mes_inicio THEN
        RAISERROR 20000 'El mes final no puede ser menor que el mes de inicio dentro del mismo a�o';
    END IF;
